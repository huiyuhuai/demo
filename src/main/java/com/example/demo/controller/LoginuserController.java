...
public class LoginuserController {
    ...
    //登陆按钮
    public List<LoginuserDO> login(@RequestParam("username") String username,@RequestParam("password") String password) {
    ...
    @GetMapping("register")
    @ResponseBody
    public List<LoginuserDO> register(@RequestParam("username") String username,@RequestParam("password") String password) {
        return loginuserService.register(username,password);
    }
}
